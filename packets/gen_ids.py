# Converts a packet enum into C++ enums.
...
with open("ids.hpp", "w") as f:
    f.write("#pragma once\n")
    f.write("#include <cstdint>\n")
    f.write("\n")
    f.write("namespace bancho::packets {\n")
    f.write("\n")
    f.write("    enum class PacketID : uint8_t {\n")
    for packet in PacketID:
        f.write(f"        {packet.name} = {packet.value},\n")
    f.write("    };\n")
    f.write("\n")
    f.write("}")
